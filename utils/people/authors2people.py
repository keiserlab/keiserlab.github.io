        ...
        paper_yml = "".join(
            [
                PAPER_TEMPLATE.format(
                    ...
                    excerpt=yml_sanitize(
                        f"{underline_author(ppr[PCOL_AUTH], ncbi_id)}. __{ppr[PCOL_JOUR]}__. {ppr[PCOL_DATE]}."
                    ),
                    link=ppr[PCOL_LINK]
                    if ppr[PCOL_LINK] != ""
                    else ppr[PCOL_PPRINT_LINK],
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--paperfile", help="Read papers from FILE", default=None)
